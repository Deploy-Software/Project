...
const HomeIcon = ({ className }: IconProps): JSX.Element => {
  return (
    <svg
      className={className}
...
const CalendarIcon = ({ className }: IconProps): JSX.Element => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
const TaskIcon = ({ className }: IconProps): JSX.Element => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
const UsersIcon = ({ className }: IconProps): JSX.Element => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
const ArrowUpIcon = ({ className }: IconProps): JSX.Element => {
  return (
    <svg
      className={className}
      fill="currentColor"
...
const ClickIcon = ({ className }: IconProps): JSX.Element => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
